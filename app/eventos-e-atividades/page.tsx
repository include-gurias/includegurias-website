"use client";
import { Box, Container, Flex, Grid, Heading, Text, Button, Spinner, GridItem } from "@chakra-ui/react";
...
const SectionRenderer = ({ title, typeKey, description, activities, isLoading }: SectionRendererProps) => {
...
const EventsActivities = () => {
    ...
    if (activitiesLoading && activities.length === 0) {
        return (
             <Container as={Flex} direction="column" align="center" justify="center" minH={"100vh"}>
