...
const EventCard = ({ id, title, text, imageUrl, date}: EventCardProps) => {
    ...
    const formattedDate = date ? new Date(date).toLocaleDateString('pt-BR') : 'Data Indefinida';
        ...
        >
            <Flex direction="column" h="full">
                ...
                >
                    ...
                    <Flex justify="space-between" align="center" mt="auto" borderTop="1px solid" borderTopColor="gray.100" pt={2}>
